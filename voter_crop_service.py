...
def process_voter():
    ...
    try:
        ...
        # Voter card la password chi garaj naste, mhanun password check kadhun takla aahe

        page = doc[0]
        
        # 🟢 Server crash roknyasathi Zoom 4.0 evji 2.5 kela aahe (Mothya PDF sathi safe)
        zoom = 2.5 
